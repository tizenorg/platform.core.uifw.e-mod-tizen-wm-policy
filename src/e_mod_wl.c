...
static void
_tz_indicator_cb_state_set(struct wl_client *client EINA_UNUSED, struct wl_resource *res_tz_indicator, struct wl_resource *surf, uint32_t state)
{
   E_Client *ec;
...
static void
_tz_indicator_cb_opacity_mode_set(struct wl_client *client EINA_UNUSED, struct wl_resource *res_tz_indicator, struct wl_resource *surf, uint32_t mode)
{
   E_Client *ec;
   E_Client *focused;
...
static void
_tz_indicator_cb_visible_type_set(struct wl_client *client EINA_UNUSED, struct wl_resource *res_tz_indicator, struct wl_resource *surf, uint32_t vtype)
{
   E_Client *ec;
