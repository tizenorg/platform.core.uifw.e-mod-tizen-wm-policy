...
typedef struct _E_Client_Rotation
{
   Eina_List     *list;
...
static Policy_Ext_Rototation* _policy_ext_rotation_get(E_Pixmap *ep);
...
_rot_hook_new_client_intern(E_Client *ec)
{
   ...
   EINA_SAFETY_ON_NULL_RETURN_VAL(hash_policy_ext_rotation, EINA_FALSE);
